...
if __name__ == '__main__':
    ...
    parser.add_argument("hs", help="the expected number of hierarchies", type=int)
    parser.add_argument("p", help="the penalty for missing entities", type=float)
    parser.add_argument(
        "cons", help="the lagrange parameter for constraints of optimization func.", type=float)
    parser.add_argument("etas", help="the density ratio for two adjacent hierarchies", type=float)
    parser.add_argument("eps", help="the convergence parameter", type=float)
